...
public:
    PressureSensor(std::string name, std::string id, std::string location);
    const int getDevType() override;
...
public:
    HumiditySensor(std::string name, std::string id, std::string location);
    const int getDevType() override;
...
public:
    LightSwitch(std::string name, std::string id, std::string location);
    const int getDevType() override;
